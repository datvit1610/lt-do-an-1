package com.codec.system.technical.infrastructure.primary.springdoc;
...
class SpringdocConfiguration {
  ...
  @Bean
  public OpenAPI codecSystemApplicationOpenAPI() {
  ...
  @Bean
  public GroupedOpenApi codecSystemApplicationAllOpenAPI() {
