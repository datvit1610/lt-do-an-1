# CodecSystemApplication errors

CodecSystemApplication errors are meant to be specialized and internationalized. That mean you'll have to create dedicated exceptions extending `CodecSystemApplicationException`, example:

```
class UnknownFileToDeleteException extends CodecSystemApplicationException {
